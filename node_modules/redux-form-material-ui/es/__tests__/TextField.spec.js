...
describe('TextField', function () {
  ...
  it('should render with defaultValue', function () {
    (0, _expect2.default)(new _TextField4.default({
      input: {
        name: 'myText',
        value: ''
    ...
    }).render()).toEqualJSX(_react2.default.createElement(_TextField2.default, { name: 'myText', value: '5', errorText: 'FooWarning', ref: 'component' }));
  });
